...
<div class="wrapper">
	<form action="JoinProc.do" method="post" name="frm">
	<div class="wrap">
			<div class="subjecet">
				<span>회원가입</span>
			</div>
			<div class="id_wrap">
				...
				<button type="button" value="중복확인" class="id_btn" onclick="idcheck()" value="N">중복확인</button>
			</div>
			<div class="pw_wrap">
...
<script>
	...
	function pwCheck() {
		if(pw1.value != pw2.value || pw1.value == '' || pw2.value == ''){
			...
			pw1.value="";
			pw2.value="";
		}else if(c.innerHTML == "사용 불가능한 아이디입니다." || c.innerHTML == '중복 확인을 해주세요.' || c.innerHTML == '중복된 아이디입니다.'){
			alert("아이디를 확인해주세요.");	
		}else{
			document.frm.submit();
		}
