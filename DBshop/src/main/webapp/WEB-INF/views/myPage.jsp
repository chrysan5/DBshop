   ...
   <div id="containAll">
      ...
      <div id="container">
         ...
         <table>
            ...
            <tr>
               <td colspan="2">
               <input class="myButton" type="button" value="회원정보 수정" onclick="location.href='Editmember.do'" /></td>
            </tr>
            <tr>
               <td colspan="2">
               <input class="myButton" type="button" value="회원 탈퇴" onclick="location.href='Deletemember.do'" /></td>
            </tr>
            <tr>
               <td colspan="2">
